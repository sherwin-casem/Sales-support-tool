...
export function CompanyDetailDrawer({
  ...
  return (
    <Drawer open={open} onClose={onClose} title={drawerTitle}>
      {focusSection === "decisionMaker" ? (
        <DecisionMakerDrawerContent profile={profile} contact={decisionMakerContact} />
      ) : (
        <CompanyOverviewDrawerContent
          result={result}
          profile={profile}
...
function DecisionMakerDrawerContent({
  profile,
  contact,
}: {
...
function CompanyOverviewDrawerContent({
  result,
  profile,
  searchCriteria,
  ...
  profile: SearchResultItemResponse["profile"];
  searchCriteria: ParsedQuery | null;
  decisionMakerContact: ReturnType<typeof resolveDecisionMakerContact>;
}) {
  return (
    <div className="space-y-6">
      ...
      {profile ? (
        <>
          ...
          {decisionMakerContact ? (
            <DecisionMakerContactPanel contact={decisionMakerContact} />
          ) : null}
